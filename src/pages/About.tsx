        ...
        <>
            ...
            <div className="w-full min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 flex flex-col justify-center items-center relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-8 py-20 text-center">
                    ...
                    {/* Main Headline - Personal approach */}
                    <h1 className="text-gray-100 text-5xl md:text-7xl lg:text-8xl font-bold font-sans mb-8 leading-tight">
                        Hola, soy
                        <span className="text-transparent bg-gradient-to-r from-lime-300 to-green-400 bg-clip-text"> DiegoDPL</span>
                    </h1>

                    {/* Personal introduction */}
                    <p className="text-gray-300 text-xl md:text-2xl font-light max-w-4xl mx-auto mb-12 leading-relaxed">
                        DJ y productor musical con más de <strong className="text-white">15 años</strong> compartiendo mi pasión por la música. 
                        Me especializo en crear <strong className="text-lime-300">sample libraries, remixes y beats</strong> que conecten con otros artistas y productores.
                    </p>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
                        <div className="text-center">
                            ...
                            <div className="text-gray-400 text-sm uppercase tracking-wider">Proyectos Musicales</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl md:text-4xl font-bold text-lime-300 mb-2">15+</div>
                            <div className="text-gray-400 text-sm uppercase tracking-wider">Años de Experiencia</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl md:text-4xl font-bold text-lime-300 mb-2">200+</div>
                            <div className="text-gray-400 text-sm uppercase tracking-wider">Sets y Remixes</div>
                        </div>
                        <div className="text-center">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
                                <p>
                                    <strong className="text-white">Año 2010.</strong> Tenía 16 años y pasaba horas escuchando música, preguntándome 
                                    cómo se creaban esos sonidos que tanto me emocionaban. Un día descargué mi primer programa de producción 
                                    musical y... bueno, digamos que mis primeros intentos fueron bastante cuestionables.
                                </p>
                                
                                <p>
                                    Pero algo me enganchó. No era solo crear música, sino la posibilidad de mezclar canciones como DJ, 
                                    de darle una nueva vida a temas que ya conocía. <strong className="text-white">Era como ser un alquimista sonoro.</strong>
                                </p>
                                
                                <p>
                                    Los años pasaron y fui puliendo mi técnica. Comencé a crear mis propios beats, luego remixes, después mashups. 
                                    Cada proyecto era una oportunidad de aprender algo nuevo. Lo que empezó como un hobby se convirtió en mi vocación.
                                </p>
                                
                                <p>
                                    <strong className="text-yellow-400">El momento más especial:</strong> Cuando trabajé en "La Historia" con 
                                    <strong className="text-white"> Lorena Santos</strong>. Ver cómo esa canción tocó a tanta gente y llegó a 
                                    <span className="text-yellow-400 font-semibold">Disco de Platino</span> fue increíble. No lo esperaba, pero me confirmó que estaba en el camino correcto.
                                </p>
                                
                                <p>
                                    Hoy comparto mi música y mis recursos porque creo que la creatividad se multiplica cuando la compartes. 
                                    Si mis samples, beats o remixes pueden inspirar a otros productores, entonces mi trabajo tiene sentido.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-4 pt-6">
                                ...
                                <div className="bg-gradient-to-r from-lime-300/10 to-green-400/10 border border-lime-300/20 rounded-full px-4 py-2">
                                    <span className="text-lime-300 text-sm font-medium">🎧 DJ Sets</span>
                                </div>
                                <div className="bg-gradient-to-r from-lime-300/10 to-green-400/10 border border-lime-300/20 rounded-full px-4 py-2">
                                    <span className="text-lime-300 text-sm font-medium">🎵 Producción Musical</span>
                                </div>
                                <div className="bg-gradient-to-r from-lime-300/10 to-green-400/10 border border-lime-300/20 rounded-full px-4 py-2">
                                    <span className="text-lime-300 text-sm font-medium">� Remixes</span>
                                </div>
                                <div className="bg-gradient-to-r from-lime-300/10 to-green-400/10 border border-lime-300/20 rounded-full px-4 py-2">
                                    <span className="text-lime-300 text-sm font-medium">📚 Sample Libraries</span>
                                </div>
                            </div>
                        </div>

                        {/* Visual Element - Journey */}
                        <div className="relative">
                            <div className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/10">
                                <h3 className="text-white text-2xl font-bold mb-8">Mi Viaje Musical</h3>
                                ...
                                <div className="space-y-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h4 className="text-white font-semibold">Los Inicios</h4>
                                            <p className="text-gray-400 text-sm">Primeros experimentos con software de música</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h4 className="text-white font-semibold">Primeros Sets</h4>
                                            <p className="text-gray-400 text-sm">Tocando en eventos locales y aprendiendo el oficio</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h4 className="text-white font-semibold">Mashups & Remixes</h4>
                                            <p className="text-gray-400 text-sm">Experimentando con nuevos sonidos y estilos</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-400 text-sm">"La Historia" con Lorena Santos - un sueño hecho realidad</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h4 className="text-white font-semibold">Compartiendo Mi Música</h4>
                                            <p className="text-gray-400 text-sm">Creando recursos para otros productores y artistas</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div className="w-full py-20 bg-gradient-to-b from-gray-950 to-gray-900">
                <div className="max-w-6xl mx-auto px-4 md:px-8">
                    <div className="text-center mb-16">
                        <span className="text-lime-300 text-sm font-semibold uppercase tracking-wider">Lo que hago</span>
                        <h2 className="text-gray-100 text-4xl md:text-5xl font-bold mt-4 mb-6">
                            Mi enfoque musical
                        </h2>
                        <p className="text-gray-300 text-xl max-w-3xl mx-auto">
                            Como DJ y productor, combino la experiencia de la cabina con el trabajo de estudio. 
                            Cada proyecto es una oportunidad de crear algo único y conectar con nuevas audiencias.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                        ...
                        <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-lime-300/30 transition-all duration-500 hover:transform hover:scale-105">
                            ...
                            <h3 className="text-white text-xl font-bold mb-4">Producción Musical</h3>
                            <p className="text-gray-300 leading-relaxed mb-4">
                                Me gusta crear beats que tengan alma. Cada producción busca contar algo, ya sea a través de melodías emotivas, 
                                ritmos que te hagan mover o texturas que sorprendan.
                            </p>
                        ...
                        <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-lime-300/30 transition-all duration-500 hover:transform hover:scale-105">
                            ...
                            <h3 className="text-white text-xl font-bold mb-4">DJ Sets en Vivo</h3>
                            <p className="text-gray-300 leading-relaxed mb-4">
                                Tocar en vivo me ha enseñado mucho sobre qué funciona realmente con la gente. Esa experiencia 
                                la llevo a mis producciones para que tengan ese elemento especial.
                            </p>
                            <div className="text-lime-300 text-sm font-medium">• Sets en Vivo • Lectura de Audiencia • Experiencia de Pista</div>
                        </div>
                        ...
                        <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-lime-300/30 transition-all duration-500 hover:transform hover:scale-105">
                            ...
                            <h3 className="text-white text-xl font-bold mb-4">Remixes & Mashups</h3>
                            <p className="text-gray-300 leading-relaxed mb-4">
                                Disfruto tomando canciones que ya conocemos y dándoles un giro totalmente nuevo. 
                                Es como redescubrir una canción que creías conocer perfectamente.
                            </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-lime-300/30 transition-all duration-500 hover:transform hover:scale-105">
                            ...
                            <h3 className="text-white text-xl font-bold mb-4">Sample Libraries</h3>
                            <p className="text-gray-300 leading-relaxed mb-4">
                                Crear sample libraries es una de mis pasiones. Me gusta que cada sonido tenga personalidad y 
                                pueda inspirar a otros productores a crear algo único.
                            </p>
                            <div className="text-lime-300 text-sm font-medium">• Drum Kits • Loops Melódicos • FX • One Shots</div>
                        </div>
                        ...
                        <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-lime-300/30 transition-all duration-500 hover:transform hover:scale-105">
                            ...
                            <h3 className="text-white text-xl font-bold mb-4">Sound Design</h3>
                            <p className="text-gray-300 leading-relaxed mb-4">
                                Me divierte experimentar con sonidos y texturas. Cada proyecto es una oportunidad de explorar 
                                nuevas atmósferas y crear elementos que den carácter a la música.
                            </p>
                            <div className="text-lime-300 text-sm font-medium">• Ambient • Efectos • Texturas • Atmósferas</div>
                        </div>
                        ...
                        <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-lime-300/30 transition-all duration-500 hover:transform hover:scale-105">
                            ...
                            <h3 className="text-white text-xl font-bold mb-4">Mezcla & Masterización</h3>
                            <p className="text-gray-300 leading-relaxed mb-4">
                                Cuidar los detalles técnicos es fundamental para que la música suene bien en cualquier sistema. 
                                Me gusta que cada elemento tenga su espacio y brille como debe.
                            </p>
                            <div className="text-lime-300 text-sm font-medium">• Mezcla • Masterización • Claridad • Punch</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full py-20 bg-gray-950">
                <div className="max-w-6xl mx-auto px-4 md:px-8">
                    <div className="text-center mb-16">
                        <span className="text-lime-300 text-sm font-semibold uppercase tracking-wider">Algunos Comentarios</span>
                        <h2 className="text-gray-100 text-4xl md:text-5xl font-bold mt-4 mb-6">
                            Lo que dicen otros artistas
                        </h2>
                    </div>
