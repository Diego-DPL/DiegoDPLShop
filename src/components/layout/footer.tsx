        ...
        <>
            <div className="w-full py-12 bg-gray-950 flex flex-col justify-start items-start gap-4 px-4 md:px-8 lg:px-16">
                <div className="w-full h-2 relative">
                    <div className="w-full h-0 absolute outline-[1.50px] outline-offset-[-0.75px] outline-white/20"></div>
                </div>
                <div className="w-full max-w-7xl mx-auto flex flex-wrap justify-start items-start gap-12">
                    ...
                    <div className="w-full sm:w-48 flex flex-col justify-center items-start gap-2">
                        ...
                        <Link to="/" className="w-full text-gray-300/60 text-base font-semibold font-['Plus_Jakarta_Sans'] leading-tight hover:text-gray-200">Inicio</Link>
                        <Link to="/about-me" className="w-full text-gray-300/60 text-base font-semibold font-['Plus_Jakarta_Sans'] leading-tight hover:text-gray-200">Sobre mí</Link>
                        <Link to="/catalog" className="w-full text-gray-300/60 text-base font-semibold font-['Plus_Jakarta_Sans'] leading-tight hover:text-gray-200">Catálogo</Link>
                    ...
                    <div className="w-full md:w-96 flex flex-col justify-center items-start gap-4">
                        <div className="w-full flex flex-col justify-start items-start gap-1">
                            ...
                            <div className="w-full text-gray-300 text-base font-medium font-['Plus_Jakarta_Sans'] leading-tight">Suscríbete a nuestro newsletter para las últimas novedades.</div>
                                                ...
                                                <form className="w-full flex justify-start items-start gap-3" onSubmit={e => {e.preventDefault(); alert('¡Gracias por suscribirte!'); setEmail('');}}>
                                                                                    <input
                                                                                        className="flex-1 px-3 py-2 bg-white/5 rounded-lg outline-[1.50px] outline-offset-[-1.50px] outline-white/20 text-gray-200 placeholder:text-gray-300/40"
                                                            ...
                                                            required
                                                        />
                                                                                    <button className="px-4 py-2 rounded-lg outline-[1.50px] outline-offset-[-1.50px] outline-gray-300/20 hover:bg-white/10" type="submit">
                                                                <div className="text-gray-300 text-base font-semibold font-['Plus_Jakarta_Sans'] leading-tight">Suscribirme</div>
                                                        </button>
                                                </form>
                    </div>
                </div>
